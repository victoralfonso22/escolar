				...
				.addGroup(gl_panelAlumno.createSequentialGroup()
					.addGroup(gl_panelAlumno.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panelAlumno.createSequentialGroup()
							...
							.addGroup(gl_panelAlumno.createParallelGroup(Alignment.LEADING)
								.addComponent(lblNombre, GroupLayout.PREFERRED_SIZE, 243, GroupLayout.PREFERRED_SIZE)
								.addComponent(labelCurp, GroupLayout.PREFERRED_SIZE, 243, GroupLayout.PREFERRED_SIZE)
								.addComponent(labelFechaNacimiento, GroupLayout.PREFERRED_SIZE, 243, GroupLayout.PREFERRED_SIZE)
								.addComponent(labelEdad, GroupLayout.PREFERRED_SIZE, 243, GroupLayout.PREFERRED_SIZE))))
					.addContainerGap())
		);
